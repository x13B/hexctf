/*
  ...
  - You are about to drop the column `timeToAnswer` on the `AnswerQuestions` table. All the data in the column will be lost.
  - Added the required column `assignedCreatedAt` to the `AnswerQuestions` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_AnswerQuestions" (
    ...
    "assignedCreatedAt" DATETIME NOT NULL,
